    ...
    <html lang="es">
      ...
      >
        ...
        <a
          ...
          className="fixed bottom-20 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-500/30 transition hover:scale-110 hover:shadow-green-500/40 md:bottom-6 md:right-6"
        >
        ...
        {/* Chat de soporte con IA (burbuja en la esquina izquierda) */}
        <ChatWidget />
      </body>
    </html>
  );
